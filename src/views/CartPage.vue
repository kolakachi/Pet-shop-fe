                ...
                <div class="cart-item">
                  <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                      ...
                      >
                        <h5 class="product-title">Brit Care Endurance</h5>
                        <p class="product-description fnt-14 fw-medium">
                          Animonda
                        </p>
                        <h4 class="product-quantity my-2">200kn</h4>
                  ...
                  <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                      <div
                        class="d-flex flex-column justify-content-center gap-1 h-100"
                      >
                        <h5 class="product-title">Royal Canin</h5>
                        <p class="product-description fnt-14 fw-medium">
                          Animonda
                        </p>
                        <h4 class="product-quantity my-2">15kn</h4>
                  ...
                  <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                      <div
                        class="d-flex flex-column justify-content-center gap-1 h-100"
                      >
                        <h5 class="product-title">Greenies</h5>
                        <p class="product-description fnt-14 fw-medium">
                          Lorem Ipsim
                        </p>
                        <h4 class="product-quantity my-2">350kn</h4>
